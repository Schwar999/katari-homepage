...
const translations = {
    en: {
        ...
        terms2Content: "Premium subscriptions are billed monthly. Pricing varies by region: $3.50/month (US) or ¥480/month (Japan). You may cancel at any time through the Stripe customer portal. All payments are processed securely through Stripe.",
    ...
    ja: {
        ...
        terms2Content: "プレミアムサブスクリプションは月額¥480で請求されます。Stripeカスタマーポータルからいつでもキャンセルできます。すべての支払いはStripeを通じて安全に処理されます。",
