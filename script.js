...
const translations = {
    en: {
        ...
        commerce6Content: "Premium Plan: ¥480/month (Japan) / $3.50/month (US)<br>Free Plan: ¥0",
    ...
    ja: {
        ...
        commerce6Title: "販売価格",
        commerce6Content: "プレミアムプラン: 月額480円（日本）/ 月額3.50米ドル（米国）<br>無料プラン: 0円",
        commerce7Title: "商品代金以外の必要料金",
        commerce7Content: "インターネット接続料金、通信料金はお客様のご負担となります。",
        commerce8Title: "支払方法",
        commerce8Content: "Google Playストアを通じたクレジットカード決済、デビットカード決済、Google Playクレジット、キャリア決済",
        commerce9Title: "支払時期",
        commerce9Content: "サブスクリプション登録時および毎月の自動更新時",
        commerce10Title: "サービスの提供時期",
        commerce10Content: "決済完了後、即時利用可能",
        commerce11Title: "返品・キャンセルについて",
        commerce11Content: "デジタルコンテンツの性質上、サービス利用開始後の返品・返金は原則として承っておりません。Google Playストアの返金ポリシーに基づき、購入後48時間以内であれば返金申請が可能です。技術的な問題でサービスが利用できない場合は、support@tommy-tech.netまでお問い合わせください。",
        commerce12Title: "動作環境",
        commerce12Content: "Android 8.0以上を搭載したスマートフォン・タブレット<br>インターネット接続環境が必要",
        ...
        terms2aItem1: "プレミアムプラン: 月額3.50米ドル（米国）または月額480円（日本）",
        ...
        terms2bItem2: "各請求期間の開始時に課金されます",
        terms2bItem3: "支払いはGoogle Playストアの安全な決済システムを通じて処理されます",
        ...
        terms4aItem1: "Google Playでの購入に対する返金は、購入後48時間以内に申請する必要があります",
        terms4aItem2: "返金リクエストはGoogle Playストアを通じて直接提出してください",
        terms4aItem3: "当社はGoogle Playの返金ポリシーとガイドラインに従います",
        terms4aItem4: "サービス利用を妨げる技術的な問題がある場合は、返金申請の前にサポートにご連絡ください",
        terms5aTitle: "5.1 キャンセル方法",
        terms5aItem1: "AndroidデバイスでGoogle Playストアアプリを開きます",
        terms5aItem2: "メニュー → 定期購入 をタップします",
        terms5aItem3: "Katari Premiumを選択し、定期購入を解約 をタップします",
        terms5aItem4: "現在の請求期間の終了までアクセスは継続します",
        terms5aItem5: "現在の請求期間の残りの日数に対する返金は行いません",
